        ...
        <div className="container" style={{ pointerEvents: 'auto' }}>
          <div>
            ...
            <h2 className="contato__title">
              <TypewriterTextTime text="Pronto para transformar" start={isLoaded} hideCursorOnDone speed={25} />
              <br />
              <motion.span
                    ...
                    {FIELD_ORDER.map((field, idx) => (
                      <motion.div
                        ...
                        variants={{
                          ...
                          visible: { opacity: 1, x: 0, transition: { duration: 0.5, delay: 0.5 + idx * 0.08 } },
                        }}
                      >
